...
The data needs to be present in the working folder:
...
The dialogue will have these parts parts:

- `D1`. Prepare for Q1, by going through the skill levels and
  following the reasoning of the paper
- `D2`. Ask Q1
- `D3.` Prepare for Q2, by supplying another line of reasoning
- `D4`. Ask Q2
...
These subsections are numbered by the abilities taugh to the AI
...
#### D1.4.10: calculate 'cage_mass_mean'
...
#### D1.4.11: calculate 'cage_mass_stdev'
...
#### D1.4.12: calculate 'cage_mass_mean_deviation_sd'
...
In these steps, we are combining knowledge.
