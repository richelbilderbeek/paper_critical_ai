...
The only difference is that this plot uses relative body masses.
The fit, however, is unfair: 
...
body masses have the highest fitness). Hence a different fit should be used.
...
This should reproduce this plot:
